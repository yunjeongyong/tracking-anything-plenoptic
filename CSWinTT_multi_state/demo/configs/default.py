...
class DefaultEngineConfig():
    def __init__(self, exp_name='default', model='aott'):
        model_cfg = importlib.import_module('CSWinTT_multi_state.demo.configs.models.' +
                                            model).ModelConfig()
        ...
        self.TRAIN_TOTAL_STEPS = 200000 #100000
    ...
    def init_dir(self):
        ...
        self.DIR_SAM = os.path.join(self.DIR_DATA, 'SAM_sub')
